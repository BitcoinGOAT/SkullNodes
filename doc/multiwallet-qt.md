...
In order to support loading of multiple wallets in skullnodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skullnodes.cpp.
...
This widget owns five page views: overviewPage, transactionsPage, addressBookPage, receiveCoinsPage, and skullnodesCoinsPage.
...
Changes to skullnodes.cpp
----------------------
skullnodes.cpp is the entry point into skullnodes-qt, and as such, will require some minor modifications to provide hooks for
