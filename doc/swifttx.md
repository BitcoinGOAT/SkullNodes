...
This mechanism has been integrated into Bitcore-Node-SkullNodes which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SkullNodes-Project/insight-api-skullnodes#web-socket-api](https://github.com/SkullNodes-Project/insight-api-skullnodes#web-socket-api) 
* API: [https://github.com/SkullNodes-Project/insight-api-skullnodes#swifttx-transactions](https://github.com/SkullNodes-Project/insight-api-skullnodes#swifttx-transactions) 
...
By default, the SkullNodes Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SkullNodes Core daemon:
