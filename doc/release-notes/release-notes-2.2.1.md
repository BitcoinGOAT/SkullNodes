SkullNodes Core version 2.2.1 is now available from:

  <https://github.com/skullnodes-project/skullnodes/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/skullnodes-project/skullnodes/issues>
...
of Bitcoin that SkullNodes was forked from.
...
- #136 `53705f1` [Qt] Fix false flags for MultiSend notification when skullnodesing transactions
