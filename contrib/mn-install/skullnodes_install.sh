...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='skullnodes.conf'
CONFIGFOLDER='/root/.skullnodes'
COIN_DAEMON='skullnodesd'
COIN_CLI='skullnodes-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BitcoinGOAT/SkullNodes/releases/download/1.0.0.2/SkullNodes-Ubuntu-16-04-x64.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='SkullNodes'
COIN_PORT=51050
RPC_PORT=51051
