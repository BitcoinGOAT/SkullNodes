...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51050;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SkullNode starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SKX: 1 day
        nTargetSpacing = 1 * 30;  // SKX: 30 seconds
        nLastPOWBlock = 1001;
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Th Goat Is Back! - 2018";
...
const int SCRYPT_SCRATCHPAD_SIZE = 131072 + 63;
        ...
        assert(hashGenesisBlock == uint256("0x0a0087cf9e0540bc978bdf549b808ea34a045d113681eaf6b8ba714f6bb840dc"));
        assert(genesis.hashMerkleRoot == uint256("0x9bd0e7d2163aa650f577b8431cdecb79c01570eae481367106faff08b1bdb94a"));

		vSeeds.push_back(CDNSSeedData("Seed node", "199.192.20.145"));     // Seed node
        //vSeeds.push_back(CDNSSeedData("dns.s.io", "seed.seio"));     // Primary DNS Seeder
        //vSeeds.push_back(CDNSSeedData("send.eorg", "seed.s.org"));    // Secondary DNS Seeder from Remapper
	...
	//vSeeds.push_back(CDNSSeedData("107.191.44.102", "107.191.44.102"));           // Single node address
        ...
        strSporkKey = "04368fe5b039ef74a4b9e9ba4f9d632f328b5a26fdd1dac454ae21fd529d2e5bac6f2495439bdf6e0b59399151589641df39559540b33ea7fa85f4ccb8765d77b1";
        ...
        nStartMasternodePayments = 1527192637; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SKX: 1 day
        nTargetSpacing = 1 * 60;  // SKX: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "se-testnet.seed2.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddnst"));
        //vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet skx addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet skx script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet skx BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet skx BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet skx BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // SKX: 1 day
        nTargetSpacing = 1 * 60;        // SKX: 1 minutes
