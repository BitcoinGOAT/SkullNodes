...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop skullnodes server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "skullnodes server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* skullnodes features */
        {"skullnodes", "masternode", &masternode, true, true, false},
        {"skullnodes", "listmasternodes", &listmasternodes, true, true, false},
        {"skullnodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"skullnodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"skullnodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"skullnodes", "masternodedebug", &masternodedebug, true, true, false},
        {"skullnodes", "startmasternode", &startmasternode, true, true, false},
        {"skullnodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"skullnodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"skullnodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"skullnodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"skullnodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"skullnodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"skullnodes", "mnbudget", &mnbudget, true, true, false},
        {"skullnodes", "preparebudget", &preparebudget, true, true, false},
        {"skullnodes", "submitbudget", &submitbudget, true, true, false},
        {"skullnodes", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"skullnodes", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"skullnodes", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"skullnodes", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"skullnodes", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"skullnodes", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"skullnodes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"skullnodes", "checkbudgets", &checkbudgets, true, true, false},
        {"skullnodes", "mnsync", &mnsync, true, true, false},
        {"skullnodes", "spork", &spork, true, true, false},
        {"skullnodes", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"skullnodes", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use skullnodesd, or the -server option to skullnodes-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"skullnodes Alert\" admin@foo.com\n"),
...
{
    return "> skullnodes-cli " + methodname + " " + args + "\n";
}
