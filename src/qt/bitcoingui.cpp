                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SkullNodes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SKX address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SkullNodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about SkullNodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SkullNodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SKX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SKX addresses"));
    ...
    openAction->setStatusTip(tr("Open a SkullNodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SkullNodes Core help message to get a list with possible SkullNodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SkullNodes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SkullNodes network", "", count));
}
...
{
    QString strTitle = tr("SkullNodes Core"); // default title
