...
QT_MOC_LITERAL(4, 38, 24), // "obfuscationRoundsChanged"
QT_MOC_LITERAL(5, 63, 26), // "anonymizeSendAmountChanged"
QT_MOC_LITERAL(6, 90, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "obfuscationRoundsChanged\0"
    "anonymizeSendAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->obfuscationRoundsChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->anonymizeSendAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::obfuscationRoundsChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeSendAmountChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void OptionsModel::obfuscationRoundsChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void OptionsModel::anonymizeSendAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
