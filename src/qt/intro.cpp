...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SkullNodes Core"),
     ...
     * override -datadir in the skullnodes.conf file in the default data directory
     * (to be consistent with skullnodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
