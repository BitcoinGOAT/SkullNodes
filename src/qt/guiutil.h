...
/** Utility functions used by the SkullNodes Qt UI.
 */
namespace GUIUtil
{
...
// Render SkullNodes addresses in monospace font
...
// Parse "skullnodes:" URI into recipient object, return true on successful parsing
