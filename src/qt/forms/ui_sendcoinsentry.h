...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        labelLabel = new QLabel(SendCoins);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The SkullNodes address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the SkullNodes: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the SkullNodes network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
