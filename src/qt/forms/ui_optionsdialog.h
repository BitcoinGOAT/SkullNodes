...
public:
    ...
    QLabel *label;
    QSpinBox *obfuscationRounds;
    QHBoxLayout *horizontalLayout;
    QLabel *label_2;
    QSpinBox *anonymizeSend;
    QWidget *tabWallet;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        obfuscationRounds = new QSpinBox(tabMain);
        obfuscationRounds->setObjectName(QStringLiteral("obfuscationRounds"));
        obfuscationRounds->setMinimum(2);
        obfuscationRounds->setMaximum(8);
        obfuscationRounds->setValue(4);

        horizontalLayout_4_Main->addWidget(obfuscationRounds);
        ...
        anonymizeSend = new QSpinBox(tabMain);
        anonymizeSend->setObjectName(QStringLiteral("anonymizeSend"));
        anonymizeSend->setMinimum(100);
        anonymizeSend->setMaximum(100000);
        anonymizeSend->setSingleStep(100);
        anonymizeSend->setValue(1000);

        horizontalLayout->addWidget(anonymizeSend);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start SkullNodes after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start SkullNodes on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "Obfuscation rounds to use", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("OptionsDialog", "This amount acts as a threshold to turn off Obfuscation once it's reached.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of SkullNodes to keep anonymized", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the SkullNodes client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the SkullNodes network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting SkullNodes.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/skullnodes-project/skullnodes-project-translations", Q_NULLPTR));
