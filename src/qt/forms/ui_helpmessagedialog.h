...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->resize(585, 394);
        QFont font;
        font.setPointSize(10);
        HelpMessageDialog->setFont(font);
        HelpMessageDialog->setWindowTitle(QStringLiteral("SkullNodes Core - Command-line options"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 457, 117));
