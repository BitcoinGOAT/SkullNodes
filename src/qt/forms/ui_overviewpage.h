...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelAnonymized->setText(QStringLiteral("0 SkullNodes"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SkullNodes network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        labelAnonymizedText->setText(QApplication::translate("OverviewPage", "Coin Mixing Balance:", Q_NULLPTR));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", Q_NULLPTR));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 SKX / 0 Rounds", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("OverviewPage", "Coin Mixing", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelObfuscationSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SkullNodes network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("OverviewPage", "Recent transactions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the SkullNodes network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
