/* src/config/skullnodes-config.h.  Generated from skullnodes-config.h.in by configure.  */
/* src/config/skullnodes-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SKULLNODES_CONFIG_H

#define SKULLNODES_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.skullnodes.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SkullNodes Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SkullNodes Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "skullnodes"
