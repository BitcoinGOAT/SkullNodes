...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Skullnodes Core skullnodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skullnodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded send transaction") + "\n" +
                               "  skullnodes-tx [options] -create [commands]   " + _("Create hex-encoded send transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded send transaction
